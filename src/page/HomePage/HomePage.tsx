...
function HomePage() {
  ...
  useEffect(() => {
    gsap.fromTo(
      ...
      { height: "auto", overflowY: "auto", delay: 1.2 }
    );
    ...
    if (title.current) {
      ...
      tl.fromTo(
        ...
        { x: 0, opacity: 1, ease: Power3.easeOut, duration: 1 },
        1.2
      )
        .fromTo(
          title2,
        ...
        .fromTo(".intro-name", { y: 44, opacity: 0 }, { y: 0, opacity: 1 }, 1.2)
        .fromTo(".logo", { x: 300, opacity: 0 }, { x: 0, opacity: 1 }, 1.2)
        .fromTo(
          [".header", ".wrap_btn-hero", ".wrap_button-scroll"],
          { opacity: 0 },
    ...
    <>
      <main>
        ...
        <div className="wrap_button-scroll">
          ...
          <div>
            <Link to="down" smooth={true} duration={500}>
              <ScrollIconDown />
            </Link>
        ...
        <section className="hero" id="hero">
          ...
          <div className="intro wrap" id="intro">
            <div className="intro-name">
              ...
              <Text
                tag="p"
                text="Thank you for visiting my portfolio. I think it will help you get to know me better."
                color="#817474"
                className="body_text"
              />
            </div>
        ...
        <section className="about" ref={about} id="about">
          ...
          <div className="body_about wrap panel ">
            ...
            <div className="first_about">
              <h3 className="first-h3">Hi, I'm Pérsi</h3>
              <Text
                tag="p"
                text=" Lorem ipsum dolor sit amet consectetur adipisicing elit. Architecto, sequi saepe maxime pariatur rem non consequatur
                                ...
                                unde quas suscipit ea placeat quia cumque laudantium assumenda dolore voluptatum ut ullam! Enim?"
                className="body_textgm"
              />
            </div>
            <div className="second_about">
              ...
              <div className="info">
                <p className="body_textgm">
                  Email &nbsp;&nbsp;: <span>andriamananandroh@gmail.com</span>
                </p>
                <p className="body_textgm">
                  Education &nbsp;&nbsp; :
                  <span>Developer front end, SAHA Academique (2023)</span>
                </p>
                <p className="body_textgm">
                  Diplôme &nbsp;&nbsp;:
                  <span> Bacc +2 électronique informatique</span>
                </p>
                <p className="body_textgm">
                  Phone &nbsp;&nbsp;:<span>+261346810380</span>
                </p>
                <p className="body_textgm">
                  City &nbsp;&nbsp;:<span>Antananarivo/Madagascar</span>
                </p>
              </div>
            </div>
          </div>
